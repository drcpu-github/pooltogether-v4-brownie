...
def calculate_prizes(network):
    ...
    while True:
        try:
            ...
            if "message" in err.args[0] and "DRB/future-draw" in err.args[0]["message"]:
                logging.info("Future draw, sleeping for 5 minutes and retrying")
                time.sleep(300)
            else:
                raise
    ...
    normalized_balances_dict, average_balances_dict = {}, {}
